                    ...
                    <div class="sidebar-widget-two categories-widget-two">
                        <div class="widget-content">
                            <ul>
                                ...
                                <li class="current"><a class="nav-link ml-3 my-1" href="{{ route('Services.kedudukandih')}}">Kedudukan dan
            ...
            <div class="col-lg-8">
                <div class="services-details pl-lg-5">
                    ...
                    <div class="content">
                        ...
                        <blockquote>
                            <h4>Kedudukan</h4><br>
                            <div class="text">Departemen Infrastruktur dan Hardware adalah unit kerja struktural
                                setingkat Departemen
                                dalam organisasi Divisi Teknologi Informasi yang berkedudukan langsung di bawah
                                Kepala
                                Divisi Teknologi Informasi serta dipimpin oleh seorang Kepala Departemen
                                lnfrastruktur dan
                                Hardware.</div>
                        </blockquote>
                        ...
                        <blockquote>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1.</td>
                                        <td>Biro Jaringan & Hardware</td>
                                    </tr>
                                    <tr>
                                        <td>2.</td>
                                        <td>Biro Pengelolaan Sistem Aplikasi dan Helpdesk Service</td>
                                    </tr>
                                </tbody>
                            </table>
                        </blockquote>
