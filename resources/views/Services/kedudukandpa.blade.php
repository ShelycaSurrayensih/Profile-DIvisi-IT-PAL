                    ...
                    <div class="sidebar-widget-two categories-widget-two">
                        <div class="widget-content">
                            <ul>
                                ...
                                <li class="current"><a class="nav-link ml-3 my-1" href="{{ route('Services.kedudukandpa')}}">Kedudukan dan
                                        Organisasi<i class="fa fa-angle-right"></i></a></li>
            ...
            <div class="col-lg-8">
                <div class="services-details pl-lg-5">
                    ...
                    <div class="content">
                        ...
                        <blockquote>
                            <h4>Kedudukan</h4><br>
                            <div class="text">Departemen Pengembangan Aplikasi dan Integrasi adalah unit kerja struktural setingkat Departemen dalam organisasi Divisi Teknologi Informasi yang berkedudukan langsung di bawah Kepala Divisi Teknologi Informasi serta dipimpin oleh seorang Kepala Departemen Pengembangan Aplikasi dan Integrasi</div>
                        </blockquote>
                            ...
                            <p>Ketua Departemen Pengembangan Aplikasi dan Integrasi membawahi dan membina :
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1.</td>
                                            <td>Biro Pengembangan Aplikasi & Integrasi</td>
                                        </tr>
                                        <tr>
                                            <td>2.</td>
                                            <td>Biro Penelitian & Pengembangan</td>
                                        </tr>
                                    </tbody>
                                </table>
                        </blockquote>
