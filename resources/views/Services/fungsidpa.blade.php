                    ...
                    <div class="sidebar-widget-two categories-widget-two">
                        <div class="widget-content">
                            <ul>
                                ...
                                <li class="current"><a class="nav-link ml-3 my-1" href="{{ route('Services.fungsidpa')}}">Fungsi<i class="fa fa-angle-right"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- Contact Form Widget -->
                        ...
                        <blockquote>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>4.</td>
                                        <td>Pembuatan buku panduan operasional untuk kepertingan perawatan dan trouble
                    ...
                    <div class="column col-lg-4">
                        <div class="footer-widget logo-widget">
                            <div class="widget-content">
                                ...
                                <div class="text">Lorem ipsum dolor sit amet, consect etur adipisicing elit, sed
                                    do
...
<!--Scroll to top-->
<div class="scroll-to-top scroll-to-target" data-target="html"><span class="fal fa-arrow-circle-up"></span>
</div>
