                    ...
                    <div class="sidebar-widget-two categories-widget-two">
                        <div class="widget-content">
                            <ul>
                                ...
                                <li class="current"><a class="nav-link ml-3 my-1" href="{{ route('Services.tugasdih')}}">Tugas Pokok<i class="fa fa-angle-right"></i></a></li>
                        ...
                        <blockquote>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1.</td>
                                        <td>Menjabarkan, menyusun strategi pelaksanaan kebijakan Divisi Teknologi Informas beserta
                                            ...
                                            usaha yang dikembangkan oleh Perusahaan.</td>
                                    </tr>
                                    <tr>
                                        <td>2.</td>
                                        <td>Merencanakan, mengkoordinir & melaksanakan, mengevalusi serta melakukan perbaikan
                                            terhadap kegiatan dalam bidang yang menjadi tanggung jawabnya</td>
                                    </tr>
                                </tbody>
                            </table>
                        </blockquote>
